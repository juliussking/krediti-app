<template>
  ...
  <div class="flex justify-between items-center mb-3 py-5">
    <div class="title">
      <h1 class="text-3xl text-gray-800 font-bold">Usuários</h1>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
    <CardTop>
      ...
      <template v-slot:icon>
        <div class="icon bg-blue-100 p-2 rounded-lg">
          <svg width="30px" height="30px" viewBox="0 0 24 24" fill="#2B7FFF">
      ...
      <template v-slot:icon>
        <div class="icon bg-green-100 p-2 rounded-lg">
          <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none">
            <path d="M14 19.2857L15.8 21L20 17M4 21C4 17.134 7.13401 14 11 14C12.4872 14 13.8662 14.4638 15 15.2547M15 7C15 9.20914 13.2091 11 11 11C8.79086 11 7 9.20914 7 7C7 4.79086 8.79086 3 11 3C13.2091 3 15 4.79086 15 7Z" stroke="#00C951" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        </div>
      </template>
    </CardTop>
    ...
    <CardTop>
      ...
      <template v-slot:mainInfo>
        {{ userStore.meta.users_inactive }}
      </template>
      
      <template v-slot:icon>
        <div class="icon bg-orange-100 p-2 rounded-lg">
          <svg width="30px" height="30px" viewBox="0 0 24 24" fill="#e0700a">
            <path d="M12 14v2a6 6 0 0 0-6 6H4a8 8 0 0 1 8-8zm0-1c-3.315 0-6-2.685-6-6s2.685-6 6-6 6 2.685 6 6-2.685 6-6 6zM18 21.5l-2.939 1.545.561-3.272-2.377-2.318 3.286-.478L18 14l1.47 2.977 3.285.478-2.377 2.318.56 3.272L18 21.5z"/>
          </svg>
        </div>
      </template>
    </CardTop>
    ...
    <CardTop>
      ...
      <template v-slot:mainInfo>
        {{ userStore.meta.users_blocked }}
      </template>
      
      <template v-slot:icon>
        <div class="icon bg-red-100 p-2 rounded-lg">
          <svg width="30px" height="30px" viewBox="0 0 24 24" fill="#C31314">
