<template>
  <div class="min-h-screen flex items-center justify-center bg-gray-100 px-4">
    <div class="bg-white p-8 rounded-xl shadow-lg w-full max-w-2xl">
      ...
      <p class="text-gray-500 text-sm text-center mb-6 mt-2">Preencha os dados para criar sua conta</p>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <BaseInput :error="!!errors.company_phone" v-model="company_phone"
                @update:modelValue="$emit('update:company_phone', $event)" type="text" placeholder="(11) 99999-0000" />
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <BaseInput :error="!!errors.admin_name" v-model="admin_name"
                @update:modelValue="$emit('update:admin_name', $event)" type="text" placeholder="Ex: João da Silva" />
              <ErrorsForm :errors="errors" attr="admin_name" />
            </div>
            <div>
              <LabelForm>Telefone</LabelForm>
              <BaseInput :error="!!errors.admin_phone" v-model="admin_phone"
                @update:modelValue="$emit('update:admin_phone', $event)" type="number" placeholder="Ex: João da Silva" />
            ...
            <div class="md:col-span-2">
              ...
              <BaseInput :error="!!errors.password" v-model="password"
                @update:modelValue="$emit('update:password', $event)" type="password" placeholder="Digite sua senha" />
      ...
      <p class="mt-4 text-sm text-center text-gray-600">
        Já tem conta? <RouterLink :to="{ name: 'login' }" class="text-blue-500 hover:underline">Faça login</RouterLink>
      </p>
    </div>
  </div>
</template>
