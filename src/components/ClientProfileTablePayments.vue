<template>
   <div class="p-4 border-b border-gray-200 flex justify-between">
      ...
      <div class=" flex gap-3">
        ...
        <p
          class="text-sm text-green-600 font-semibold bg-blue-50 px-2 py-1 rounded hover:bg-blue-100  cursor-pointer mr-3">
          Novo pagamento</p>
      </div>
    </div>
  ...
  <div class="bg-white shadow rounded overflow-x-auto">
    ...
    <table class="w-full divide-y divide-gray-200 text-sm">
      ...
      <tbody class="divide-y divide-gray-100">
        <tr v-for="payment in clientProfile?.payments" :key="payment.id"
          ...
          <td class="px-6 py-4">
            <span 
          :class="{'text-green-900 bg-green-300 px-2 py-1 rounded-full': payment.payment_type === 'Fator',
